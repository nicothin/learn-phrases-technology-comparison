    ...
    <div className="admin">
      <div className="admin__sup-table">
        <div className="input-text admin__search">
          <label className="input-text__label"><textarea name="search" rows={1} className="input-text__input" placeholder="Search (3+ characters)" style="height: 36px;"></textarea></label>
        </div>
